    ...
    case 'save':
        ...
        if ($id_cliente == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'CLIENTE REGISTRADO CON EXITO');
                } else {
            ...
            if ($result) {
                $res = array('tipo' => 'success', 'mensaje' => 'CLIENTE MODIFICADO CON EXITO');
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL MODIFICAR CLIENTE');
            }
        }
