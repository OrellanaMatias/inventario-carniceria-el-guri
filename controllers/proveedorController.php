...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_proveedor == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'PROVEEDOR REGISTRADO CON EXITO');
                } else {
                    $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR');
                }
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'EL TELEFONO YA EXISTE INGRESA OTRO DIFERENTE');
            }
        } else {
            $result = $proveedor->updateProveedor($nombre, $telefono, $direccion, $id_proveedor);
            if ($result) {
                $res = array('tipo' => 'success', 'mensaje' => 'PROVEEDOR MODIFICADO CON EXITO');
            } else {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'PROVEEDOR ELIMINADO CON EXITO');
        } else {
