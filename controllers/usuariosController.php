...
switch ($option) {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'USUARIO ELIMINADO CON EXITO');
        } else {
    ...
    case 'savePermiso':
        ...
        if (!empty($_POST['permisos'])) {
            ...
            if ($res) {
                $res = array('tipo' => 'success', 'mensaje' => 'PERMISOS ASIGNADO AL USUARIO');
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR LOS PERMISOS AL USUARIO');
            }
